...
\section{Linguagem}
Trabalharemos com a linguagem lógica modal $K_n$. %TODO write a small introduction for the section and describe its structure, probably define syntax and semantics
...
\begin{definition}
	Uma cláusula proposicional é uma disjunção de literais proposicionais. %TODO describe disjuntion, maybe create a lexical subsection before syntax
\end{definition}

Assim, uma cláusula proposicional tem a forma $p_1 \lor p_2 \lor \cdots p_m$ com $p_i \in \set{P}$ e $m \in \mathbf{N}$, para $m = 0$ a cláusula é dita vazia.
